...
function Salgados() {
  ...
  // Dados dos salgados (usando pães como modelo)
  const salgados = [
    { id: 201, nome: "Salgado Modelo 1", valor: "5,00", descricao: "Descrição do salgado modelo 1...", imagem: "/assets/img/imgsPadaria/pao1.png" },
    { id: 202, nome: "Salgado Modelo 2", valor: "5,80", descricao: "Descrição do salgado modelo 2...", imagem: "/assets/img/imgsPadaria/pao2.png" },
  ];
